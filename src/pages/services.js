    ...
    return(
        ...
        <div className="container">
            ...
            <div className="row my-4 align-items-center">
                <div className="col-12 col-md-6">
                     <Image  src ="/servicio2.jpg" width={0} height={0}  layout='responsive' alt="..." />   
                </div>
                <div className="col-12 col-md-6">
                    ...
                    <p>Correo:<strong className="text-danger fw-bold">republicadeparaguay1146@gmail.com</strong>  </p>
        ...
        {/* <div className='py-2 bg-primary'></div> */}
            ...
            <div className="row my-4 flex-md-row-reverse align-items-center">
                <div className="col-12 col-md-6">
                     <Image  src ="/servicio1.jpg" width={0} height={0}  layout='responsive' alt="imagenServicios" />   
                </div>
                <div className="col-12 col-md-6">
                    <h2 className="my-4">Servicios y registros académicos</h2>
                    <p>
                    Nos encargamos de emitir documentos oficiales de la Escuela de Postgrado, asimismo validamos la situación académica de los alumnos y egresados a través de Atención Alumno EPG. Consultas al correo: <strong className="text-danger fw-bold">republicadeparaguay1146@gmail.com</strong> ​ 
                    </p>
                </div>
            </div>
        </div>
